...
export const CLEANING_SUBTASKS: SubtaskDef[] = [
  ...
  { key: 'wc_1', icon: '🚽', label: 'WC 1' },
  { key: 'wc_2', icon: '🚽', label: 'WC 2' },
  { key: 'cozinha', icon: '🍳', label: 'Cozinha' },
  { key: 'sala_estar', icon: '🛋️', label: 'Sala estar' },
  { key: 'sala_jantar', icon: '🍽️', label: 'Sala jantar' },
  { key: 'varanda', icon: '🌤️', label: 'Varanda' },
  { key: 'terraco', icon: '🌅', label: 'Terraço' },
  { key: 'escadas', icon: '🪜', label: 'Escadas' },
  { key: 'hall', icon: '🚪', label: 'Hall' },
  { key: 'lixo', icon: '🗑️', label: 'Lixo' },
